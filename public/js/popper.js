  ...
  function N(t, o, i) {
    ...
    return (
      n.forEach(function (t) {
        ...
        t.enabled &&
          e(i) &&
          ((o.offsets.popper = h(o.offsets.popper)), (o.offsets.reference = h(o.offsets.reference)), (o = i(o, t)));
      }),
      o
    );
  }
              ...
              s = {
                ...
                secondary: function (e) {
                  var o = "right" === e ? "left" : "top",
                    n = p[o];
                  return (
                    p[e] > i[e] && !t.escapeWithReference && (n = V(p[o], i[e] - ("right" === e ? p.width : p.height))),
                    se({}, o, n)
                  );
                }
              };
